...
class AsistenciaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('asistencia.index')
            ->with('success', 'Asistencia creada satisfactoriamente.');
    }
    ...
    public function show($id)
    {
        ...
        return view('asistencia.marcarasistencia', compact('asistencia'));
    }
    ...
    public function update(Request $request, Asistencia $asistencia)
    {
        ...
        return redirect()->route('asistencia.index')
            ->with('success', 'Asistencia actualizada satisfactoriamente.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('asistencia.index')
            ->with('success', 'Asistencia eliminada satisfactoriamente.');
    }
